                ...
                <div>
                            ...
                            <a className={style.user} href="javascript:void (0)">
                                <div className={style.userData}>
                                    ...
                                    <span className={style.userTime}>
                                        ￥{this.props.asset.friendWard.totalAmount}
                                    </span>
                                </div>
                            </a>
                        </div>
                    ...
                    <div className={style.content}>
                        ...
                        <div className={style.contentContent}>
                            {this.props.asset.friendWard.awardList.length === 0 ? <div>
                                ...
                                <ListView
                                    ...
                                    dataSource={(() => {
                                        ...
                                        return dataSource.cloneWithRows(this.props.asset.friendWard.awardList)
                                    })()}
