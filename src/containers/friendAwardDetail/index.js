...
class BaseUserMsg extends React.Component {
    ...
    genData(pIndex = 0) {
        return this.props.asset.awardDetails.list;
    }
            ...
            <div className={style.wrap}>
                ...
                <div>
                            ...
                            <a className={style.user} href="javascript:void (0)">
                                <div className={style.userData}>
                                    ...
                                    <span className={style.userTime}>
                                        {this.props.asset.awardDetails&&this.props.asset.awardDetails.totalAmount}
                                    </span>
                                </div>
                            </a>
                    ...
                    <div className={style.content}>
                        ...
                        {this.props.asset.awardDetails && this.props.asset.awardDetails.list.length === 0 ? <div>
